...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 0,     std::make_pair(hashGenesisBlock, 1462075200) )
        ( 500, std::make_pair(uint256("0x0000014730e3d7835a53fdb974588625bf172c77d5c617c90c6542a65155a498"), 1462564234) )
    ;
    ...
    static MapCheckpoints mapCheckpointsTestnet =
        boost::assign::map_list_of
        ( 0, std::make_pair(hashGenesisBlockTestNet, 1462075200) )
        ;
