...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "http://explorer.iticoin.com/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "http://explorer.iticoin.com/tx/%s").toString();
