...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "http://explorer.super-ppl.com/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "http://explorer.super-ppl.com/tx/%s").toString();
