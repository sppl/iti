...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ITI");
    case mBTC: return QString("mITI");
    case uBTC: return QString::fromUtf8("μITI");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("iTiCoins"));
    case mBTC: return QString(QObject::tr("Milli-iTiCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-iTiCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
